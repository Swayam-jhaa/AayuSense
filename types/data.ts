...
export const mockSampleResults: SampleResult[] = [
  ...
  },
  {
    ...
    shap: [
      ...
      { feature: "Reduction value", impact: 0.35 },
...
export const mockHerbProfiles: HerbProfile[] = [
  ...
  // Add these fields to each herb object in mockHerbProfiles
{
  herb_id: "ashwagandha",
  name: "Ashwagandha",
  scientific_name: "Withania somnifera",
  family: "Solanaceae",
  description: "A powerful adaptogen used in Ayurveda.",
  taste_profile: "Bitter, astringent, earthy",
  ayurvedic_properties: {
    rasa: ["Bitter", "Astringent"],
    virya: "Heating",
    vipaka: "Sweet",
    prabhava: "Adaptogenic"
  },
  phytochemicals: {
    primary: ["Withanolides", "Alkaloids"],
    secondary: ["Saponins", "Steroidal lactones"]
  },
  quality_indicators: {
    expected_ranges: { pH: "6.5-7.5", EC: "1.2-1.8" },
    adulteration_markers: ["Starch", "Synthetic withanolides"]
  },
  major_uses: ["Stress relief", "Improves vitality", "Supports immunity"],
  cures: ["Anxiety", "Fatigue", "Inflammation"],
  side_effects: ["Drowsiness", "Upset stomach"]
},
{
    herb_id: "H002",
    name: "Turmeric",
